      ...
      <form  >
        <div className="signup-container">
          ...
          <div className="items">
            ...
            <input type="number" placeholder="Phone Number" value={data.phone} name="phone" onChange={changehandle} required/>
            <input type="text" placeholder="Enter Password" value={data.password}  name="password" onChange={changehandle}/>
            <input type="text" placeholder="Enter Club Name" value={data.password}  name="clubname" onChange={changehandle}/>
            <input type="text" placeholder="Security key" value={data.password}  name="securitykey" onChange={changehandle} required/>
